       ...
       <input type="hidden" id="id" name="id" value="${user.id }" />
        <div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <select class="form-control" name="faRange" data-value="${user.faRange }">
		    ...
		    <div class="col-sm-4">
		       <select class="form-control" name="soRange" data-value="${user.soRange }">
		       <option value="">无权限</option>
		  ...
		  <div class="form-group">		    
		    ...
		    <div class="col-sm-4">
		      <select class="form-control" id="isDisable" name="isDisable"  data-value="${user.isDisable }">
		    ...
		    <div class="col-sm-4">
		      <input type="text" id="pwd" name="pwd" class="form-control" placeholder="如果不修改请保持空" />
		    </div>
		  </div>
		  <div class="form-group">
